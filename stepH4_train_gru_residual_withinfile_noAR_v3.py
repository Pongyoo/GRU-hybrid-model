# ============================================================
# stepH4_train_gru_residual_withinfile_noAR_v3.py  (v3) [PATCHED]
# Phase 4: Train GRU as Residual AR-Compensator (leakage-safe)
#
# PATCH (stride-consistent delta):
#  - Change target from 1-sample delta to stride-sample delta:
#      dr_stride = r[t_end] - r[t_end - stride]
#  - Use mask to drop sequences where prev_idx < 0 (clean, no cheating)
#  - Keep NO-AR input the same (no residual history in X)
# ============================================================
...
def main():
    ...
    D = X.shape[-1]   # NO-AR: keep original feature dim (4)
    ...
    # ----- PATCH START: stride-consistent delta target -----
    ...
    print("\n=== Task definition ===")
    print("Input : [I_rms, f_inst, G_res, A_phys] (NO residual history)")
